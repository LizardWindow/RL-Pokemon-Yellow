...
if __name__ == '__main__':
    ...
    #model = PPO.load('./train/best_model_20480.zip')
    #model = PPO('CnnPolicy', env, verbose=1, tensorboard_log=LOG_DIR, learning_rate=0.000001,n_steps=4096)
    model = PPO('CnnPolicy', env, verbose=1, tensorboard_log=LOG_DIR,n_steps=ep_length // 8, batch_size=128, n_epochs=3, gamma=0.998,device="cuda",learning_rate=0.00001)
